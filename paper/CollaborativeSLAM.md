...
> **Paper:** *HERCULES: An Open-Source Simulation Framework for Heterogeneous Multi-Robot SLAM, Collaborative Perception, and Exploration*; Sandilya Sai Garimella, Daniel Chase Butterfield, Sean Wilson, and Lu Gan
...
The code for running this experiment can be found in the original repository: [ORB-SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3).
