...
colcon --log-base "$HERCULES_BUILD_ROOT/log" test \
  ...
  --packages-select airsim_ros_pkgs hercules_cbf hercules_cbf_ros hercules_control hercules_tracking hercules_tracking_ros hercules_localization hercules_localization_ros hercules_mission_core hercules_mission_ros --event-handlers console_direct+ "$@"
