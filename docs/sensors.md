...
HERCULES currently supports the following sensors.    
...
Behind the scenes, 'createDefaultSensorSettings' method in [AirSimSettings.hpp](https://github.com/lunarlab-gatech/HERCULES/blob/main/AirLib/include/common/AirSimSettings.hpp) which sets up the above sensors with their default parameters, depending on the sim mode specified in the `settings.json` file. 
