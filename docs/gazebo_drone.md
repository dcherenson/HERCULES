...
Run from your HERCULES root folder:  
```
./clean.sh
./setup.sh
./build.sh --gcc
...
The Cosys-AirSim UE plugin needs to be built with clang, so you can't use the one compiled in the previous step. You can use [our binaries](https://github.com/microsoft/AirSim/releases) or you can clone HERCULES again in another folder and buid it without the above option, then you can [run Blocks](install_linux.md#how-to-use-hercules) or your own environment.
...
You may want to change the visual model of the HERCULES drone, for that you can follow [this tutorial.](https://youtu.be/Bp86WiLUC80)
