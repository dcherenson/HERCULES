...
If you wish to not build the plugin from source, you can download the precompiled plugin from the [releases page](https://github.com/lunarlab-gatech/HERCULES/releases) for the right version of Unreal you are using. 
