# Multiple Vehicles in HERCULES

Since release 1.2, HERCULES is fully enabled for multiple vehicles. This capability allows you to create multiple vehicles easily and use APIs to control them.
...
The new APIs since HERCULES 1.2 allows you to specify `vehicle_name`. This name corresponds to keys in json settings (for example, Car1 or Drone2 above).

[Example code for cars](https://github.com/lunarlab-gatech/HERCULES/blob/main/PythonClient/car/multi_agent_car.py)

[Example code for multirotors](https://github.com/lunarlab-gatech/HERCULES/blob/main/PythonClient/multirotor/multi_agent_drone.py)
...
[![HERCULES Multiple Vehicles Demo Video](images/demo_multi_vehicles.png)](https://youtu.be/35dgcuLuF5M)

### Creating vehicles at runtime through API

In the latest main branch of HERCULES, the `simAddVehicle` API can be used to create vehicles at runtime. This is useful to create many such vehicles without needing to specify them in the settings. There are some limitations of this currently, described below -
...
For some examples, check out [HelloSpawnedDrones.cpp](https://github.com/lunarlab-gatech/HERCULES/blob/main/HelloSpawnedDrones/HelloSpawnedDrones.cpp) -

![HelloSpawnedDrones](images/HelloSpawnedDrones.gif)

And [runtime_car.py](https://github.com/lunarlab-gatech/HERCULES/blob/main/PythonClient/car/runtime_car.py) -
