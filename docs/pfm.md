...
HERCULES has code to write pfm file for [C++](https://github.com/lunarlab-gatech/HERCULES/blob/main/AirLib/include/common/common_utils/Utils.hpp#L637) and read as well as write for [Python](https://github.com/lunarlab-gatech/HERCULES/tree/main/PythonClient/airsim/utils.py#L122).
