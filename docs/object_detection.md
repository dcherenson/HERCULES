...
## About
This feature lets you generate object detection using existing cameras in HERCULES, similar to detection DNN.   
...
```
## Usage example
Python script [detection.py](https://github.com/lunarlab-gatech/HERCULES/blob/main/PythonClient/detection/detection.py) shows how to set detection parameters and shows the result in OpenCV capture.
